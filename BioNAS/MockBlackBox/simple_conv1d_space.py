...
from ..Controller.state_space import *
...
def get_data():
    ...
    '''
    #pos_file = './BioNAS/resources/simdata/DensityEmbedding_motifs-MYC_known1_min-0_max-2_mean-1_zeroProb-0_seqLength-200_numSeqs-10000.fa.gz'
    pos_file = resource_filename('BioNAS.resources', 'simdata/DensityEmbedding_motifs-MYC_known1_min-1_max-1_mean-1_zeroProb-0p0_seqLength-200_numSeqs-10000.fa.gz')
    ...
    X, y = data_parser.get_data_from_fastaSequence(pos_file, neg_file)
