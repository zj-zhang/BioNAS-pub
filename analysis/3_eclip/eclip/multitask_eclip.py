...
tf_mem.KTF.set_session(tf_mem.get_session(gpu_fraction=0.5))

from BioNAS.Controller.controller import *
from BioNAS.Controller.model import build_sequential_model, build_multiGPU_sequential_model
...
def get_reward_func(mkf):
	...
	for K.
	'''
	reward_fn = Knowledge_Reward(mkf, Lambda=0.25)
	return reward_fn
...
def train_simple_controller(wd):
	...
	model_fn = build_multiGPU_sequential_model
